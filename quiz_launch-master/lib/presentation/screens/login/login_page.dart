                ...
                child: Container(
                  ...
                  child: TextFormField(
                    decoration: InputDecoration(
                      ...
                      prefixIcon: Icon(Icons.email_outlined,color: Colours.primaryColor,), 
                    ),
                  ),
            ...
            Card(
                ...
                child: Container(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      prefixIcon: Icon(Icons.message_outlined,color: Colours.primaryColor,), 
                    ),
                  ), 
                ),
              ...
              SizedBox(height: 50,),
                      ...
                      Container(
                        ...
                        children: [
                          Text(login.text3,style: TextStyle(fontSize: 14,color: Colours.textColour,fontWeight: FontWeight.w400),),
                          RichText(text: TextSpan(text:login.richText1,style: TextStyle(fontSize: 14,color:Colours.primaryColor,fontWeight: FontWeight.w500))),
                      ...
                      SizedBox(height: 5,),
                         Container(
                          margin: EdgeInsets.only(left: 120),
                           child: Column(
                           children: [RichText(text: TextSpan(text:login.richText2,style: TextStyle(fontSize: 14,color:Colours.primaryColor,fontWeight: FontWeight.w500))),],
                                              ),
                         )
