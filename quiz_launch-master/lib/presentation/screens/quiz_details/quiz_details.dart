                ...
                child: Column(
                  ...
                  children: [
                    Container(
                        ...
                        child: Text(Quizdetailsconstant.textcard1,
                            style: TextStyle(
                    ...
                    Container(
                        margin: EdgeInsets.only(left: 18),
                        child: Text(Quizdetailsconstant.textcard2,
                            style: TextStyle(
                                fontFamily: FontFamily.rubik,
                                fontSize: 24,
                                fontWeight: FontWeight.w500,
                            ...
                            Container(
                              child: Row(
                                ...
                                children: [
                                  ...
                                  SizedBox(width: 5, height: 10),
                                  Text(Quizdetailsconstant.textcard4,
                                      style: TextStyle(
                                          fontFamily: FontFamily.rubik,
                                          fontSize: 16,
                                          fontWeight: FontWeight.w500)),
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(Quizdetailsconstant.textcard5,
                              style: TextStyle(
                                  fontFamily: FontFamily.rubik,
                                  fontSize: 14,
                                  fontWeight: FontWeight.w500,
                          ...
                          Text(Quizdetailsconstant.textcard6,
                              style: TextStyle(
                                  fontFamily: FontFamily.rubik,
                                  fontSize: 16,
